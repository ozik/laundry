...
$pdf->Cell(189 ,5,'Laporan Data Layanan',0,1,'C');//end of line
$pdf->Cell(189 ,10,'',0,1);//end of line


$pdf->SetFont('Arial','B',12);
$pdf->Cell(10 ,7,'No',0,0);
$pdf->Cell(25 ,7,'Id Layanan',0,0);
$pdf->Cell(40 ,7,'Nama Layanan',0,0);
$pdf->Cell(25 ,7,'Jenis',0,0);
$pdf->Cell(25 ,7,'Satuan',0,0);
$pdf->Cell(25 ,7,'Harga',0,0);
$pdf->Cell(32 ,7,'Waktu pengerjaan',0,1);
...
$pdf->Cell(40 ,6,$lihat[1],0,0);
$pdf->Cell(25 ,6,$lihat[2],0,0);
$pdf->Cell(25 ,6,$lihat[3],0,0);
$pdf->Cell(25 ,6,$lihat[4],0,0);
$pdf->Cell(32 ,6,$lihat[5].' Hari',0,1);
$no++;
}
