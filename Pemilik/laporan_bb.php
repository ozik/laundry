...
$pdf->Cell(189 ,5,'Laporan Data bahan baku',0,1,'C');//end of line
$pdf->Cell(189 ,10,'',0,1);//end of line
$pdf->SetFont('Arial','B',12);
$pdf->Cell(12 ,7,'No',0,0);
$pdf->Cell(40 ,7,'Id Bahan baku',0,0);
$pdf->Cell(32 ,7,'Bahan baku',0,0);
$pdf->Cell(45 ,7,'Stok',0,1);
$query=mysqli_query($koneksi,"SELECT * FROM tb_bb");
$no=1;
while($lihat=mysqli_fetch_row($query)){
$pdf->SetFont('Arial','',12);
$pdf->Cell(12 ,6,$no,0,0);
$pdf->Cell(40 ,6,$lihat[0],0,0);
$pdf->Cell(32 ,6,$lihat[1],0,0);
$pdf->Cell(45 ,6,$lihat[2],0,1);
$no++;
}
$pdf->Output();
?>