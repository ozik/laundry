...
$pdf->Cell(189 ,5,'Laporan Data Pelanggan',0,1,'C');//end of line
...
$pdf->Cell(36 ,7,'Nama',0,0);
$pdf->Cell(55 ,7,'Alamat',0,0);
$pdf->Cell(30 ,7,'Jenis kel',0,0);
...
$pdf->Cell(36 ,6,$lihat[1],0,0);
$pdf->Cell(55 ,6,$lihat[2],0,0);
$pdf->Cell(30 ,6,$lihat[3],0,0);
$pdf->Cell(25 ,6,$lihat[4],0,1);
$no++;
}
